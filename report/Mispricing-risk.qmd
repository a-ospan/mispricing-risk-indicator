...
The Mispricing Risk Indicator provides a structured way to track asset pricing risk using U.S. financial data. By combining equity returns, volatility, exchange rates, treasury yields, sovereign spread conditions, and housing prices, the indicator shows how risk changes across different market conditions. The results show higher risk during periods of strong asset price growth and supportive financial conditions, especially during the 2020 to 2021 recovery period. The indicator declined in 2022 as interest rates rose and financial conditions tightened, then began to rebound in 2023 and 2024 as markets recovered.

The project demonstrates how financial time series analysis, percentile scoring, threshold classification, and component level interpretation can be used to build a practical risk monitoring tool.
